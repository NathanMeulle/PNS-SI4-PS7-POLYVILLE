...
var script = {
  ...
  setup(props) {
    ...
    vue.onMounted(async () => {
      const { control, setOptions } = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
...
var script$3 = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      const { tileLayer, DomEvent, setOptions } = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
        'leaflet/dist/leaflet-src.esm'
      )); });
...
var script$5 = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      const { polyline, DomEvent, setOptions } = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
        'leaflet/dist/leaflet-src.esm'
      )); });
...
var script$6 = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      const { tooltip, DomEvent, setOptions } = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
        'leaflet/dist/leaflet-src.esm'
      )); });
...
var script$7 = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      const { popup, DomEvent, setOptions } = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
        'leaflet/dist/leaflet-src.esm'
      )); });
...
var script$8 = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      const { polygon, DomEvent, setOptions } = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
        'leaflet/dist/leaflet-src.esm'
      )); });
...
var script$9 = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      const { rectangle, latLngBounds, DomEvent, setOptions } = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
        'leaflet/dist/leaflet-src.esm'
      )); });
