import { onUnmounted, watch, ref, provide, inject, onMounted, reactive, nextTick, onBeforeUnmount, computed, openBlock, createBlock, renderSlot, createCommentVNode, h } from 'vue';
  ...
  const methods = {
    ...
    setLatLng(newVal) {
      ...
      if (leafletRef.value) {
        ...
        const newLatLng = newVal;//latLng(newVal);
        if (
...
export { script as LControlLayers, script$4 as LIcon, script$1 as LMap, script$2 as LMarker, script$8 as LPolygon, script$5 as LPolyline, script$7 as LPopup, script$9 as LRectangle, script$3 as LTileLayer, script$6 as LTooltip };
